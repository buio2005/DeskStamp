...
1. Download the ZIP file, https://github.com/buio2005/DeskStamp/releases/latest/download/DeskStamp-source.zip extract the folder, and run Start-DeskStamp.cmd
